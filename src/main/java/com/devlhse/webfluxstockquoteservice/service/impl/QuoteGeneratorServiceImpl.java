package com.devlhse.webfluxstockquoteservice.service.impl;

import com.devlhse.webfluxstockquoteservice.model.Quote;
import com.devlhse.webfluxstockquoteservice.service.QuoteGeneratorService;
...
public class QuoteGeneratorServiceImpl implements QuoteGeneratorService {
    ...
    public QuoteGeneratorServiceImpl(){
        ...
        this.prices.add(new Quote("CCB", 14.29));
    }
    ...
    public Flux<Quote> fetchQuoteStream(Duration period) {
        ...
        .map(quote -> {
            ...
            return quote;
                ...
                .log("com.devlhse.service.QuoteGenerator");
    }
